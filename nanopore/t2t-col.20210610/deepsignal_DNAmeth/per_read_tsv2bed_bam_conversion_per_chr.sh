...
# csmit -m 400G -c 48 "bash ./per_read_tsv2bed_bam_conversion_per_chr.sh Col_0_deepsignalDNAmeth_30kb_90pc t2t-col.20210610 48 5G CHH Chr1" 
...
##rm ${prefix}_MappedOn_${refbase}_${context}_${chr}.bed
